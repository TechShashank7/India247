...
const TrackerPage = () => {
  ...
  const fetchComplaint = async (manualId = null) => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:5000/api/complaints/${idToFetch.trim()}`);
  ...
  useEffect(() => {
    if (complaint?.assignedOfficer?.name) {
      ...
      fetch(`http://localhost:5000/api/complaints/officer/performance/${officerName}`)
        .then(res => res.json())
  ...
  const handleReopen = async () => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:5000/api/complaints/${complaint._id}/reopen`, {
        method: "POST",
        body: formData
      });
                    ...
                    <button
                      ...
                      onClick={async (e) => {
                        ...
                        try {
                          ...
                          const res = await fetch(`http://localhost:5000/api/complaints/${complaint._id}/rate`, {
                            method: "POST",
